...
/**
 * Fetch all abis from @web3bindings/prototype-protocol-contracts into the `abis` folder.
 */
async function generateAbis () {
  var base = require('path').dirname(require.resolve('@web3bindings/prototype-protocol-contracts/build/contracts/UController.json'))
